...
#include <memory>
#include "../../../src/camera-app/camera.h"
...
Q_CONSTINIT static const qt_meta_stringdata_Camera_t qt_meta_stringdata_Camera = {
    {
        ...
        QT_MOC_LITERAL(7, 14),  // "recordFinished"
        QT_MOC_LITERAL(22, 0)   // ""
    },
    "Camera",
    "recordFinished",
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->recordFinished(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Camera::recordFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
